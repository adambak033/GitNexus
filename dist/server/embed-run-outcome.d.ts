...
import { type EmbeddingRunIdentity } from '../core/embedding-checkpoint.js';
import { type PersistedEmbeddingCount } from '../core/embedding-count.js';
 ...
 */
export declare const resolveEmbedRunOutcome: (identity: EmbeddingRunIdentity, result: EmbeddingRunResult, context?: EmbedRunFinalizeContext) => EmbedRunOutcome;
/**
 ...
 */
export declare const withMeasuredEmbeddingCount: (meta: RepoMeta, 
/** `undefined` ≡ this write measured nothing (e.g. the window-start save). */
measured: PersistedEmbeddingCount | undefined) => RepoMeta;
