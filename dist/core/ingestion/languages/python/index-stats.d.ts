 ...
 */
export declare function recordPythonFileIndexBuild(): void;
export declare function getPythonFileIndexBuildCount(): number;
export declare function resetPythonFileIndexBuildCount(): void;
