...
import { isSpringAutoConfigurationDeclaration, isSpringAutoConfigurationSyntheticClass, } from '../ingestion/frameworks/spring/auto-configuration.js';
import { isSpringAopEvidenceNode } from '../ingestion/frameworks/spring/aop.js';
const isGraphWideNode = (node) => node.label === 'Community' ||
    node.label === 'Process' ||
...
const isGraphWideRelationship = (relationship) => relationship.type === 'TAINT_PATH' ||
