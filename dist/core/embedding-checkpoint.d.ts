 ...
 */
export declare const EMBEDDING_RESUME_MAX_ATTEMPTS = 3;
/**
 ...
 */
export declare const checkpointKind: (checkpoint: EmbeddingCheckpoint) => EmbeddingCheckpointKind;
/** Pending-node count, tolerating the field's optionality. */
export declare const pendingNodeCount: (checkpoint: EmbeddingCheckpoint) => number;
/**
 ...
 */
export declare const nextAttemptCount: (resumedFrom: EmbeddingCheckpoint | undefined, failedNodeIds: readonly string[]) => number | undefined;
/**
 ...
 */
export declare const mintInterruptedCheckpoint: (identity: EmbeddingRunIdentity, progress: EmbeddingCheckpointProgress, pendingNodeIds: string[], at?: string) => EmbeddingCheckpoint;
/**
 ...
 */
export declare const mintPartialCheckpoint: (identity: EmbeddingRunIdentity, result: {
    nodesProcessed: number;
    chunksProcessed: number;
    failedNodeIds: string[];
}, resumedFrom: EmbeddingCheckpoint | undefined, at?: string) => EmbeddingCheckpoint;
/**
 ...
 */
export declare const mintUnverifiedCountCheckpoint: (identity: EmbeddingRunIdentity, progress: EmbeddingCheckpointProgress, at?: string) => EmbeddingCheckpoint;
 ...
 */
export declare const decideEmbeddingResume: (checkpoint: EmbeddingCheckpoint, identity: EmbeddingRunIdentity | undefined, options?: {
    force?: boolean;
