...
import { type EmbeddingRequestOptions } from './http-client.js';
/**
 ...
 */
export declare const embedText: (text: string, options?: EmbeddingRequestOptions) => Promise<Float32Array>;
/**
 ...
 */
export declare const embedBatch: (texts: string[], options?: EmbeddingRequestOptions) => Promise<Float32Array[]>;
/**
