 ...
 */
export declare const LBUG_QUERY_BATCH_SIZE = 100;
/**
 ...
 */
export declare const LBUG_ID_PROBE_BATCH_SIZE = 1000;
/**
 ...
 */
export declare function warnIfQueryTextUnbounded(cypher: string, context: string, warn: (message: string) => void): void;
