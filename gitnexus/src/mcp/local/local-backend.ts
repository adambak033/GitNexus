...
export class LocalBackend {
  ...
  private async query(
    ...
    // #trpc-fork: defaults raised (limit 5 → 10, max_symbols 10 → 25) to fit a
    // procedure→workflow→helper chain inside a single page. The tool schema
    // mirrors these defaults.
